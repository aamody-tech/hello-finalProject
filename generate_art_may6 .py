...
def generate_art(path: str):
    print(
        "What color do you want to start the picture with? (R = red, B = blue, G = green)"
    )
    start_color = input()
    ...
    # print("What color background do you want? B=black, W=white)") *Attempt to let users choose bg color
    # image_bg_color = input()
    # if image_bg_color == "B" or image_bg_color == "black":
    #    (0, 0, 0)
    # elif image_bg_color == "W" or image_bg_color == "white":
    #    (255, 255, 255)
    # image_bg_color = int(image_bg_color)
    ...
    print("How many lines would you like drawn on your masterpiece?")
    number_points_str = input()
    number_lines = (int(number_points_str)) - 1
    points = []

    # Generate Points
    for thisthing in range(number_lines):
        random_point = (
